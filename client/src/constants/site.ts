...
export const PRIZES = [
  {
    ...
    extras: ["Certificate"],
    highlight: true,
    headerClass: "prize-header-orange",
    headerBg: "#f97316",
  },
  {
    title: "Second Prize",
    titleHindi: "द्वितीय पुरस्कार",
    ...
    extras: ["Certificate"],
    highlight: false,
    headerClass: "prize-header-navy",
    headerBg: "#0f172a",
  },
  {
    title: "Third Prize",
    titleHindi: "तृतीय पुरस्कार",
    titleEn: "Third Prize",
    rank: "3",
    icon: "🥉",
    amount: "Trophy & Certificate",
    extras: ["Certificate"],
    highlight: false,
    headerClass: "prize-header-teal",
    headerBg: "#0f766e",
  },
  {
    title: "Top 30",
    titleHindi: "शीर्ष 30 पुरस्कार",
    titleEn: "Top 30",
    rank: "30",
    icon: "🏆",
    amount: "Medal & Certificate",
    extras: ["Merit Recognition"],
    highlight: false,
    headerClass: "prize-header-green",
    headerBg: "#16a34a",
  },
  {
    title: "Participation",
    titleHindi: "प्रतिभागिता",
